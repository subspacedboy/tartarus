...
impl<'a> Permission<'a> {
  ...
  pub fn receive_events(&self) -> bool {
    ...
    unsafe { self._tab.get::<bool>(Permission::VT_RECEIVE_EVENTS, Some(false)).unwrap()}
  }
  #[inline]
  pub fn can_unlock(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(Permission::VT_CAN_UNLOCK, Some(false)).unwrap()}
  }
  #[inline]
  pub fn can_lock(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(Permission::VT_CAN_LOCK, Some(false)).unwrap()}
  }
  #[inline]
  pub fn can_release(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(Permission::VT_CAN_RELEASE, Some(false)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> PermissionBuilder<'a, 'b, A> {
  ...
  pub fn add_receive_events(&mut self, receive_events: bool) {
    self.fbb_.push_slot::<bool>(Permission::VT_RECEIVE_EVENTS, receive_events, false);
  }
  #[inline]
  pub fn add_can_unlock(&mut self, can_unlock: bool) {
    self.fbb_.push_slot::<bool>(Permission::VT_CAN_UNLOCK, can_unlock, false);
  }
  #[inline]
  pub fn add_can_lock(&mut self, can_lock: bool) {
    self.fbb_.push_slot::<bool>(Permission::VT_CAN_LOCK, can_lock, false);
  }
  #[inline]
  pub fn add_can_release(&mut self, can_release: bool) {
    self.fbb_.push_slot::<bool>(Permission::VT_CAN_RELEASE, can_release, false);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> PermissionBuilder<'a, 'b, A> {
...
impl<'a> Bot<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.permissions { builder.add_permissions(x); }
  ...
  pub fn name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Bot::VT_NAME, None)}
  }
  #[inline]
  pub fn public_key(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Bot::VT_PUBLIC_KEY, None)}
  }
  #[inline]
  pub fn permissions(&self) -> Option<Permission<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Permission>>(Bot::VT_PERMISSIONS, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> BotBuilder<'a, 'b, A> {
  ...
  pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Bot::VT_NAME, name);
  }
  #[inline]
  pub fn add_public_key(&mut self, public_key: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Bot::VT_PUBLIC_KEY, public_key);
  }
  #[inline]
  pub fn add_permissions(&mut self, permissions: flatbuffers::WIPOffset<Permission<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Permission>>(Bot::VT_PERMISSIONS, permissions);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> BotBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    BotBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> Contract<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.bots { builder.add_bots(x); }
    if let Some(x) = args.public_key { builder.add_public_key(x); }
  ...
  pub fn serial_number(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(Contract::VT_SERIAL_NUMBER, Some(0)).unwrap()}
  }
  #[inline]
  pub fn public_key(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    // Safety:
  ...
  #[inline]
  pub fn bots(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Bot<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Bot>>>>(Contract::VT_BOTS, None)}
  }
  #[inline]
  pub fn terms(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Contract::VT_TERMS, None)}
  }
  #[inline]
...
pub struct ContractArgs<'a> {
    ...
    pub public_key: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, u8>>>,
    pub bots: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Bot<'a>>>>>,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ContractBuilder<'a, 'b, A> {
  ...
  pub fn add_serial_number(&mut self, serial_number: u16) {
    self.fbb_.push_slot::<u16>(Contract::VT_SERIAL_NUMBER, serial_number, 0);
  }
  #[inline]
  pub fn add_public_key(&mut self, public_key: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
  ...
  #[inline]
  pub fn add_bots(&mut self, bots: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Bot<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Contract::VT_BOTS, bots);
  }
  #[inline]
  pub fn add_terms(&mut self, terms: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Contract::VT_TERMS, terms);
  }
  #[inline]
...
impl<'a> StartedUpdate<'a> {
  ...
  pub fn public_key(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(StartedUpdate::VT_PUBLIC_KEY, None)}
  }
  #[inline]
  pub fn session(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(StartedUpdate::VT_SESSION, None)}
  }
  #[inline]
  ...
  pub fn is_locked(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(StartedUpdate::VT_IS_LOCKED, Some(false)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> StartedUpdateBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_public_key(&mut self, public_key: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StartedUpdate::VT_PUBLIC_KEY, public_key);
  }
  #[inline]
  pub fn add_session(&mut self, session: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StartedUpdate::VT_SESSION, session);
  }
  #[inline]
  ...
  pub fn add_is_locked(&mut self, is_locked: bool) {
    self.fbb_.push_slot::<bool>(StartedUpdate::VT_IS_LOCKED, is_locked, false);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> StartedUpdateBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> PeriodicUpdate<'a> {
  ...
  pub fn session(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(PeriodicUpdate::VT_SESSION, None)}
  }
  #[inline]
  pub fn is_locked(&self) -> bool {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(PeriodicUpdate::VT_IS_LOCKED, Some(false)).unwrap()}
  }
  #[inline]
  pub fn current_contract_serial(&self) -> u16 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(PeriodicUpdate::VT_CURRENT_CONTRACT_SERIAL, Some(0)).unwrap()}
  }
  #[inline]
  pub fn local_unlock(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(PeriodicUpdate::VT_LOCAL_UNLOCK, Some(false)).unwrap()}
  }
  #[inline]
  pub fn local_lock(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(PeriodicUpdate::VT_LOCAL_LOCK, Some(false)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> PeriodicUpdateBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_session(&mut self, session: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(PeriodicUpdate::VT_SESSION, session);
  }
  #[inline]
  pub fn add_is_locked(&mut self, is_locked: bool) {
    self.fbb_.push_slot::<bool>(PeriodicUpdate::VT_IS_LOCKED, is_locked, false);
  }
  #[inline]
  pub fn add_current_contract_serial(&mut self, current_contract_serial: u16) {
    self.fbb_.push_slot::<u16>(PeriodicUpdate::VT_CURRENT_CONTRACT_SERIAL, current_contract_serial, 0);
  }
  #[inline]
  pub fn add_local_unlock(&mut self, local_unlock: bool) {
    self.fbb_.push_slot::<bool>(PeriodicUpdate::VT_LOCAL_UNLOCK, local_unlock, false);
  }
  #[inline]
  pub fn add_local_lock(&mut self, local_lock: bool) {
    self.fbb_.push_slot::<bool>(PeriodicUpdate::VT_LOCAL_LOCK, local_lock, false);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> PeriodicUpdateBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> Acknowledgement<'a> {
  ...
  pub fn public_key(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Acknowledgement::VT_PUBLIC_KEY, None)}
  }
  #[inline]
  pub fn session(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Acknowledgement::VT_SESSION, None)}
  }
  #[inline]
  pub fn serial_number(&self) -> u16 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(Acknowledgement::VT_SERIAL_NUMBER, Some(0)).unwrap()}
  }
  #[inline]
  pub fn counter(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(Acknowledgement::VT_COUNTER, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> AcknowledgementBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_public_key(&mut self, public_key: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Acknowledgement::VT_PUBLIC_KEY, public_key);
  }
  #[inline]
  pub fn add_session(&mut self, session: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Acknowledgement::VT_SESSION, session);
  }
  #[inline]
  pub fn add_serial_number(&mut self, serial_number: u16) {
    self.fbb_.push_slot::<u16>(Acknowledgement::VT_SERIAL_NUMBER, serial_number, 0);
  }
  #[inline]
  pub fn add_counter(&mut self, counter: u16) {
    self.fbb_.push_slot::<u16>(Acknowledgement::VT_COUNTER, counter, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> AcknowledgementBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> Error<'a> {
  ...
  pub fn public_key(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Error::VT_PUBLIC_KEY, None)}
  }
  #[inline]
  pub fn session(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Error::VT_SESSION, None)}
  }
  #[inline]
  pub fn serial_number(&self) -> u16 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(Error::VT_SERIAL_NUMBER, Some(0)).unwrap()}
  }
  #[inline]
  pub fn counter(&self) -> u16 {
    // Safety:
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ErrorBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_public_key(&mut self, public_key: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Error::VT_PUBLIC_KEY, public_key);
  }
  #[inline]
  pub fn add_session(&mut self, session: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Error::VT_SESSION, session);
  }
  #[inline]
  pub fn add_serial_number(&mut self, serial_number: u16) {
    self.fbb_.push_slot::<u16>(Error::VT_SERIAL_NUMBER, serial_number, 0);
  }
  #[inline]
  pub fn add_counter(&mut self, counter: u16) {
...
impl<'a> LockCommand<'a> {
  ...
  pub fn contract_serial_number(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(LockCommand::VT_CONTRACT_SERIAL_NUMBER, Some(0)).unwrap()}
  }
  #[inline]
  pub fn serial_number(&self) -> u16 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(LockCommand::VT_SERIAL_NUMBER, Some(0)).unwrap()}
  }
  #[inline]
  pub fn counter(&self) -> u16 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(LockCommand::VT_COUNTER, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> LockCommandBuilder<'a, 'b, A> {
  ...
  pub fn add_contract_serial_number(&mut self, contract_serial_number: u16) {
    self.fbb_.push_slot::<u16>(LockCommand::VT_CONTRACT_SERIAL_NUMBER, contract_serial_number, 0);
  }
  #[inline]
  pub fn add_serial_number(&mut self, serial_number: u16) {
    self.fbb_.push_slot::<u16>(LockCommand::VT_SERIAL_NUMBER, serial_number, 0);
  }
  #[inline]
  pub fn add_counter(&mut self, counter: u16) {
    self.fbb_.push_slot::<u16>(LockCommand::VT_COUNTER, counter, 0);
  }
  #[inline]
...
impl<'a> UnlockCommand<'a> {
  ...
  pub fn contract_serial_number(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(UnlockCommand::VT_CONTRACT_SERIAL_NUMBER, Some(0)).unwrap()}
  }
  #[inline]
  pub fn serial_number(&self) -> u16 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(UnlockCommand::VT_SERIAL_NUMBER, Some(0)).unwrap()}
  }
  #[inline]
  pub fn counter(&self) -> u16 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(UnlockCommand::VT_COUNTER, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> UnlockCommandBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_contract_serial_number(&mut self, contract_serial_number: u16) {
    self.fbb_.push_slot::<u16>(UnlockCommand::VT_CONTRACT_SERIAL_NUMBER, contract_serial_number, 0);
  }
  #[inline]
  pub fn add_serial_number(&mut self, serial_number: u16) {
    self.fbb_.push_slot::<u16>(UnlockCommand::VT_SERIAL_NUMBER, serial_number, 0);
  }
  #[inline]
  pub fn add_counter(&mut self, counter: u16) {
    self.fbb_.push_slot::<u16>(UnlockCommand::VT_COUNTER, counter, 0);
  }
  #[inline]
...
impl<'a> ReleaseCommand<'a> {
  ...
  pub fn contract_serial_number(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(ReleaseCommand::VT_CONTRACT_SERIAL_NUMBER, Some(0)).unwrap()}
  }
  #[inline]
  pub fn serial_number(&self) -> u16 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(ReleaseCommand::VT_SERIAL_NUMBER, Some(0)).unwrap()}
  }
  #[inline]
  pub fn counter(&self) -> u16 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(ReleaseCommand::VT_COUNTER, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ReleaseCommandBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_contract_serial_number(&mut self, contract_serial_number: u16) {
    self.fbb_.push_slot::<u16>(ReleaseCommand::VT_CONTRACT_SERIAL_NUMBER, contract_serial_number, 0);
  }
  #[inline]
  pub fn add_serial_number(&mut self, serial_number: u16) {
    self.fbb_.push_slot::<u16>(ReleaseCommand::VT_SERIAL_NUMBER, serial_number, 0);
  }
  #[inline]
  pub fn add_counter(&mut self, counter: u16) {
    self.fbb_.push_slot::<u16>(ReleaseCommand::VT_COUNTER, counter, 0);
  }
  #[inline]
...
impl<'a> AbortCommand<'a> {
  ...
  pub fn contract_serial_number(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(AbortCommand::VT_CONTRACT_SERIAL_NUMBER, Some(0)).unwrap()}
  }
  #[inline]
  pub fn serial_number(&self) -> u16 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(AbortCommand::VT_SERIAL_NUMBER, Some(0)).unwrap()}
  }
  #[inline]
  pub fn counter(&self) -> u16 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(AbortCommand::VT_COUNTER, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> AbortCommandBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_contract_serial_number(&mut self, contract_serial_number: u16) {
    self.fbb_.push_slot::<u16>(AbortCommand::VT_CONTRACT_SERIAL_NUMBER, contract_serial_number, 0);
  }
  #[inline]
  pub fn add_serial_number(&mut self, serial_number: u16) {
    self.fbb_.push_slot::<u16>(AbortCommand::VT_SERIAL_NUMBER, serial_number, 0);
  }
  #[inline]
  pub fn add_counter(&mut self, counter: u16) {
    self.fbb_.push_slot::<u16>(AbortCommand::VT_COUNTER, counter, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> AbortCommandBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    AbortCommandBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> ResetCommand<'a> {
  ...
  pub fn session(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ResetCommand::VT_SESSION, None)}
  }
  #[inline]
  pub fn serial_number(&self) -> u16 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(ResetCommand::VT_SERIAL_NUMBER, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ResetCommandBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_session(&mut self, session: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ResetCommand::VT_SESSION, session);
  }
  #[inline]
  pub fn add_serial_number(&mut self, serial_number: u16) {
    self.fbb_.push_slot::<u16>(ResetCommand::VT_SERIAL_NUMBER, serial_number, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> ResetCommandBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    ResetCommandBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> SignedMessage<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.authority_identifier { builder.add_authority_identifier(x); }
  ...
  pub fn authority_identifier(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(SignedMessage::VT_AUTHORITY_IDENTIFIER, None)}
  }
  #[inline]
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SignedMessageBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_authority_identifier(&mut self, authority_identifier: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SignedMessage::VT_AUTHORITY_IDENTIFIER, authority_identifier);
  }
  #[inline]
