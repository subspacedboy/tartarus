...
impl<'a> GetLatestFirmwareResponse<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.version { builder.add_version(x); }
    if let Some(x) = args.signature { builder.add_signature(x); }
    if let Some(x) = args.firmware { builder.add_firmware(x); }
  ...
  pub fn firmware(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(GetLatestFirmwareResponse::VT_FIRMWARE, None)}
  }
  #[inline]
  pub fn signature(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(GetLatestFirmwareResponse::VT_SIGNATURE, None)}
  }
  #[inline]
  pub fn version(&self) -> Option<Version<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Version>>(GetLatestFirmwareResponse::VT_VERSION, None)}
  }
  #[inline]
  pub fn name(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(GetLatestFirmwareResponse::VT_NAME, None)}
  }
  #[inline]
  pub fn size_(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(GetLatestFirmwareResponse::VT_SIZE_, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> GetLatestFirmwareResponseBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_firmware(&mut self, firmware: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(GetLatestFirmwareResponse::VT_FIRMWARE, firmware);
  }
  #[inline]
  pub fn add_signature(&mut self, signature: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(GetLatestFirmwareResponse::VT_SIGNATURE, signature);
  }
  #[inline]
  pub fn add_version(&mut self, version: flatbuffers::WIPOffset<Version<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Version>>(GetLatestFirmwareResponse::VT_VERSION, version);
  }
  #[inline]
  pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(GetLatestFirmwareResponse::VT_NAME, name);
  }
  #[inline]
  pub fn add_size_(&mut self, size_: u16) {
    self.fbb_.push_slot::<u16>(GetLatestFirmwareResponse::VT_SIZE_, size_, 0);
  }
  #[inline]
...
impl<'a> GetFirmwareChunkRequest<'a> {
  ...
  pub fn name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(GetFirmwareChunkRequest::VT_NAME, None)}
  }
  #[inline]
  pub fn offset(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(GetFirmwareChunkRequest::VT_OFFSET, Some(0)).unwrap()}
  }
  #[inline]
  pub fn bytes(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(GetFirmwareChunkRequest::VT_BYTES, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> GetFirmwareChunkRequestBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(GetFirmwareChunkRequest::VT_NAME, name);
  }
  #[inline]
  pub fn add_offset(&mut self, offset: u16) {
    self.fbb_.push_slot::<u16>(GetFirmwareChunkRequest::VT_OFFSET, offset, 0);
  }
  #[inline]
  pub fn add_bytes(&mut self, bytes: u16) {
    self.fbb_.push_slot::<u16>(GetFirmwareChunkRequest::VT_BYTES, bytes, 0);
  }
  #[inline]
...
impl<'a> GetFirmwareChunkResponse<'a> {
  ...
  pub fn size_(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(GetFirmwareChunkResponse::VT_SIZE_, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> GetFirmwareChunkResponseBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_size_(&mut self, size_: u16) {
    self.fbb_.push_slot::<u16>(GetFirmwareChunkResponse::VT_SIZE_, size_, 0);
  }
  #[inline]
