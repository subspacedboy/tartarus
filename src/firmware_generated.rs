...
impl MessagePayload {
  ...
  pub fn variant_name(self) -> Option<&'static str> {
    match self {
      ...
      Self::FirmwareChallengeResponse => Some("FirmwareChallengeResponse"),
      Self::GetLatestFirmwareRequest => Some("GetLatestFirmwareRequest"),
      Self::GetLatestFirmwareResponse => Some("GetLatestFirmwareResponse"),
...
impl<'a> Version<'a> {
  ...
  pub const VT_VERSION_NAME: flatbuffers::VOffsetT = 6;
  ...
  pub fn name(&self) -> Option<&'a str> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Version::VT_NAME, None)}
  }
  #[inline]
  pub fn version_name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Version::VT_VERSION_NAME, None)}
  }
  #[inline]
  pub fn signature(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Version::VT_SIGNATURE, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> VersionBuilder<'a, 'b, A> {
  ...
  pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Version::VT_NAME, name);
  }
  #[inline]
  pub fn add_version_name(&mut self, version_name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Version::VT_VERSION_NAME, version_name);
  }
  #[inline]
  pub fn add_signature(&mut self, signature: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Version::VT_SIGNATURE, signature);
  }
  #[inline]
...
impl<'a> FirmwareChallengeRequest<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.latest { builder.add_latest(x); }
  ...
  pub fn nonce(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(FirmwareChallengeRequest::VT_NONCE, None)}
  }
  #[inline]
  pub fn latest(&self) -> Option<Version<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Version>>(FirmwareChallengeRequest::VT_LATEST, None)}
  }
}
...
pub struct FirmwareChallengeRequestBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> FirmwareChallengeRequestBuilder<'a, 'b, A> {
  ...
  pub fn add_nonce(&mut self, nonce: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FirmwareChallengeRequest::VT_NONCE, nonce);
  }
  #[inline]
  pub fn add_latest(&mut self, latest: flatbuffers::WIPOffset<Version<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Version>>(FirmwareChallengeRequest::VT_LATEST, latest);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> FirmwareChallengeRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<FirmwareChallengeRequest<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}
...
impl<'a> FirmwareChallengeResponse<'a> {
  ...
  pub fn signature(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(FirmwareChallengeResponse::VT_SIGNATURE, None)}
  }
  #[inline]
  pub fn version(&self) -> Option<Version<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Version>>(FirmwareChallengeResponse::VT_VERSION, None)}
  }
}
...
pub struct FirmwareChallengeResponseBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> FirmwareChallengeResponseBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_signature(&mut self, signature: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FirmwareChallengeResponse::VT_SIGNATURE, signature);
  }
  #[inline]
  pub fn add_version(&mut self, version: flatbuffers::WIPOffset<Version<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Version>>(FirmwareChallengeResponse::VT_VERSION, version);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> FirmwareChallengeResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<FirmwareChallengeResponse<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}
...
impl<'a> GetLatestFirmwareRequest<'a> {
  ...
  pub fn version(&self) -> Option<Version<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Version>>(GetLatestFirmwareRequest::VT_VERSION, None)}
  }
}
...
pub struct GetLatestFirmwareRequestBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> GetLatestFirmwareRequestBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_version(&mut self, version: flatbuffers::WIPOffset<Version<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Version>>(GetLatestFirmwareRequest::VT_VERSION, version);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> GetLatestFirmwareRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<GetLatestFirmwareRequest<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}
...
impl<'a> GetLatestFirmwareResponse<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.version_name { builder.add_version_name(x); }
    if let Some(x) = args.firmware_name { builder.add_firmware_name(x); }
  ...
  pub fn digest(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(GetLatestFirmwareResponse::VT_DIGEST, None)}
  }
  #[inline]
  pub fn firmware_name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(GetLatestFirmwareResponse::VT_FIRMWARE_NAME, None)}
  }
  #[inline]
  pub fn version_name(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(GetLatestFirmwareResponse::VT_VERSION_NAME, None)}
  }
  #[inline]
  pub fn size_(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(GetLatestFirmwareResponse::VT_SIZE_, Some(0)).unwrap()}
  }
}
...
pub struct GetLatestFirmwareResponseBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> GetLatestFirmwareResponseBuilder<'a, 'b, A> {
  ...
  pub fn add_digest(&mut self, digest: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(GetLatestFirmwareResponse::VT_DIGEST, digest);
  }
  #[inline]
  pub fn add_firmware_name(&mut self, firmware_name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(GetLatestFirmwareResponse::VT_FIRMWARE_NAME, firmware_name);
  }
  #[inline]
  pub fn add_version_name(&mut self, version_name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(GetLatestFirmwareResponse::VT_VERSION_NAME, version_name);
  }
  #[inline]
  pub fn add_size_(&mut self, size_: i32) {
    self.fbb_.push_slot::<i32>(GetLatestFirmwareResponse::VT_SIZE_, size_, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> GetLatestFirmwareResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<GetLatestFirmwareResponse<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}
...
impl<'a> GetFirmwareChunkRequest<'a> {
  ...
  pub fn firmware_name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(GetFirmwareChunkRequest::VT_FIRMWARE_NAME, None)}
  }
  #[inline]
  pub fn offset(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(GetFirmwareChunkRequest::VT_OFFSET, Some(0)).unwrap()}
  }
  #[inline]
  pub fn size_(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(GetFirmwareChunkRequest::VT_SIZE_, Some(0)).unwrap()}
  }
}
...
pub struct GetFirmwareChunkRequestBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> GetFirmwareChunkRequestBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_firmware_name(&mut self, firmware_name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(GetFirmwareChunkRequest::VT_FIRMWARE_NAME, firmware_name);
  }
  #[inline]
  pub fn add_offset(&mut self, offset: i32) {
    self.fbb_.push_slot::<i32>(GetFirmwareChunkRequest::VT_OFFSET, offset, 0);
  }
  #[inline]
  pub fn add_size_(&mut self, size_: i32) {
    self.fbb_.push_slot::<i32>(GetFirmwareChunkRequest::VT_SIZE_, size_, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> GetFirmwareChunkRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> GetFirmwareChunkResponse<'a> {
  ...
  pub fn size_(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(GetFirmwareChunkResponse::VT_SIZE_, Some(0)).unwrap()}
  }
  #[inline]
  pub fn offset(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(GetFirmwareChunkResponse::VT_OFFSET, Some(0)).unwrap()}
  }
  #[inline]
  pub fn chunk(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(GetFirmwareChunkResponse::VT_CHUNK, None)}
  }
}
...
pub struct GetFirmwareChunkResponseBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> GetFirmwareChunkResponseBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_size_(&mut self, size_: i32) {
    self.fbb_.push_slot::<i32>(GetFirmwareChunkResponse::VT_SIZE_, size_, 0);
  }
  #[inline]
  pub fn add_offset(&mut self, offset: i32) {
    self.fbb_.push_slot::<i32>(GetFirmwareChunkResponse::VT_OFFSET, offset, 0);
  }
  #[inline]
  pub fn add_chunk(&mut self, chunk: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(GetFirmwareChunkResponse::VT_CHUNK, chunk);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> GetFirmwareChunkResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<GetFirmwareChunkResponse<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}
...
impl<'a> FirmwareMessage<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.session_token { builder.add_session_token(x); }
  ...
  pub fn payload_type(&self) -> MessagePayload {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<MessagePayload>(FirmwareMessage::VT_PAYLOAD_TYPE, Some(MessagePayload::NONE)).unwrap()}
  }
  #[inline]
  pub fn payload(&self) -> Option<flatbuffers::Table<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(FirmwareMessage::VT_PAYLOAD, None)}
  }
  #[inline]
  pub fn request_id(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(FirmwareMessage::VT_REQUEST_ID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn session_token(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FirmwareMessage::VT_SESSION_TOKEN, None)}
  }
  #[inline]
  #[allow(non_snake_case)]
  pub fn payload_as_firmware_challenge_request(&self) -> Option<FirmwareChallengeRequest<'a>> {
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn payload_as_firmware_challenge_response(&self) -> Option<FirmwareChallengeResponse<'a>> {
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn payload_as_get_latest_firmware_request(&self) -> Option<GetLatestFirmwareRequest<'a>> {
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn payload_as_get_latest_firmware_response(&self) -> Option<GetLatestFirmwareResponse<'a>> {
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn payload_as_get_firmware_chunk_request(&self) -> Option<GetFirmwareChunkRequest<'a>> {
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn payload_as_get_firmware_chunk_response(&self) -> Option<GetFirmwareChunkResponse<'a>> {
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> FirmwareMessageBuilder<'a, 'b, A> {
  ...
  pub fn add_payload_type(&mut self, payload_type: MessagePayload) {
    self.fbb_.push_slot::<MessagePayload>(FirmwareMessage::VT_PAYLOAD_TYPE, payload_type, MessagePayload::NONE);
  }
  #[inline]
  pub fn add_payload(&mut self, payload: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FirmwareMessage::VT_PAYLOAD, payload);
  }
  #[inline]
  pub fn add_request_id(&mut self, request_id: i64) {
    self.fbb_.push_slot::<i64>(FirmwareMessage::VT_REQUEST_ID, request_id, 0);
  }
  #[inline]
  pub fn add_session_token(&mut self, session_token: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FirmwareMessage::VT_SESSION_TOKEN, session_token);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> FirmwareMessageBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub fn root_as_firmware_message(buf: &[u8]) -> Result<FirmwareMessage, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_firmware_message(buf: &[u8]) -> Result<FirmwareMessage, flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_firmware_message_unchecked(buf: &[u8]) -> FirmwareMessage {
...
pub unsafe fn size_prefixed_root_as_firmware_message_unchecked(buf: &[u8]) -> FirmwareMessage {
  flatbuffers::size_prefixed_root_unchecked::<FirmwareMessage>(buf)
}
#[inline]
pub fn finish_firmware_message_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
...
#[inline]
pub fn finish_size_prefixed_firmware_message_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>, root: flatbuffers::WIPOffset<FirmwareMessage<'a>>) {
