...
impl<'a> CommonMetadata<'a> {
  ...
  pub fn lock_session(&self) -> Option<&'a str> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(CommonMetadata::VT_LOCK_SESSION, None)}
  }
  #[inline]
  pub fn contract_serial_number(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(CommonMetadata::VT_CONTRACT_SERIAL_NUMBER, Some(0)).unwrap()}
  }
  #[inline]
  pub fn serial_number(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(CommonMetadata::VT_SERIAL_NUMBER, Some(0)).unwrap()}
  }
  #[inline]
  pub fn counter(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(CommonMetadata::VT_COUNTER, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> CommonMetadataBuilder<'a, 'b, A> {
  ...
  pub fn add_lock_session(&mut self, lock_session: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(CommonMetadata::VT_LOCK_SESSION, lock_session);
  }
  #[inline]
  pub fn add_contract_serial_number(&mut self, contract_serial_number: u16) {
    self.fbb_.push_slot::<u16>(CommonMetadata::VT_CONTRACT_SERIAL_NUMBER, contract_serial_number, 0);
  }
  #[inline]
  pub fn add_serial_number(&mut self, serial_number: u16) {
    self.fbb_.push_slot::<u16>(CommonMetadata::VT_SERIAL_NUMBER, serial_number, 0);
  }
  #[inline]
  pub fn add_counter(&mut self, counter: u16) {
    self.fbb_.push_slot::<u16>(CommonMetadata::VT_COUNTER, counter, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> CommonMetadataBuilder<'a, 'b, A> {
...
impl<'a> Event<'a> {
  ...
  pub fn metadata(&self) -> Option<CommonMetadata<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<CommonMetadata>>(Event::VT_METADATA, None)}
  }
  #[inline]
  pub fn event_type(&self) -> EventType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<EventType>(Event::VT_EVENT_TYPE, Some(EventType::Undefined)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for Event<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<CommonMetadata>>("metadata", Self::VT_METADATA, false)?
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> EventBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_metadata(&mut self, metadata: flatbuffers::WIPOffset<CommonMetadata<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<CommonMetadata>>(Event::VT_METADATA, metadata);
  }
  #[inline]
  pub fn add_event_type(&mut self, event_type: EventType) {
    self.fbb_.push_slot::<EventType>(Event::VT_EVENT_TYPE, event_type, EventType::Undefined);
  }
  #[inline]
...
impl<'a> SignedEvent<'a> {
  ...
  pub fn signature(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SignedEvent::VT_SIGNATURE, None)}
  }
  #[inline]
  pub fn payload(&self) -> Option<Event<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Event>>(SignedEvent::VT_PAYLOAD, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SignedEventBuilder<'a, 'b, A> {
  ...
  pub fn add_signature(&mut self, signature: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SignedEvent::VT_SIGNATURE, signature);
  }
  #[inline]
  pub fn add_payload(&mut self, payload: flatbuffers::WIPOffset<Event<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Event>>(SignedEvent::VT_PAYLOAD, payload);
  }
  #[inline]
...
pub fn root_as_signed_event(buf: &[u8]) -> Result<SignedEvent, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_signed_event(buf: &[u8]) -> Result<SignedEvent, flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn size_prefixed_root_as_signed_event_unchecked(buf: &[u8]) -> SignedEvent {
...
#[inline]
pub fn finish_size_prefixed_signed_event_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>, root: flatbuffers::WIPOffset<SignedEvent<'a>>) {
