...
import { CommandType } from '../../../../club/subjugated/fb/message/command-type.js';
...
contract(obj?:Contract):Contract|null {
  const offset = this.bb!.__offset(this.bb_pos, 10);
  return offset ? (obj || new Contract()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
}

commandType():CommandType {
  const offset = this.bb!.__offset(this.bb_pos, 12);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : CommandType.Undefined;
}
...
static addContract(builder:flatbuffers.Builder, contractOffset:flatbuffers.Offset) {
  builder.addFieldOffset(3, contractOffset, 0);
}

static addCommandType(builder:flatbuffers.Builder, commandType:CommandType) {
  builder.addFieldInt8(4, commandType, CommandType.Undefined);
}
