...
class SignedEvent : Table() {
    ...
    val payload : club.subjugated.fb.event.Event? get() = payload(club.subjugated.fb.event.Event())
    fun payload(obj: club.subjugated.fb.event.Event) : club.subjugated.fb.event.Event? {
        val o = __offset(6)
        return if (o != 0) {
